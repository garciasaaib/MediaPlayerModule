/**
 * Contiene todos los adds que se van a mostrar, los videos obtendran los adds de esta clase
 * No queremos que los adds se dupliquen por lo tanto vamos a usar un singleton
 * Singleton
 * - instancia privada
 * - constructor privado
...
//constante que contiene todos los adds que serán usados
// cada ad sigue la estructura de Ad
// aunque podrian obtenerse de algun api
const ALL_ADS: Ad[] = [
  {
    imageUrl:
...
// Ads va a ser un arreglo de Ad
class Ads {
  private static instance: Ads
  private ads: Ad[] //ads = arreglo de muchos objetos Ad

  private constructor () {
    //la primera instancia creada hará esto
    this.initAds()
  }
  ...
  //ads = array de Ad
  //toma un ad de la lista, lo usa y lo reduce de la lista
  getAd() {
